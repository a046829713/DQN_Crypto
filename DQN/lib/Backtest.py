...
class RL_evaluate():
    def __init__(self) -> None:
        ...
        data = DataFeature().get_train_net_work_data(symbol="TRBUSDT",
                                                     data_path=r'DQN\simulation\data\TRBUSDT-F-30-Min.csv')
        ...
        self.agent = self.load_model(
            model_path=r'saves\20240307-165545-50k-False-BTCUSDT\checkpoint-632.pt')
